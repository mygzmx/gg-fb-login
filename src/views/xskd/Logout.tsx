...
import logoImg from "@/common/logos/xskd.png";
...
import styles from '@/views/xskd/index.module.scss';

const clientId = "481045629470-n3gr08qtki9s9ufhfrgj7vbpaub75tb8.apps.googleusercontent.com";
const appId = "1069241123251013";
const appName = "小說快讀";
