...
import logoImg from "@/common/logos/krfic.png";
...
import LoginBtn from "@/views/krfic/LoginBtn";
import { loginInit } from "@/utils/loginInit";
import jwtDecode from "jwt-decode";
import AvatarDefaultIcon from "@/common/images/krfic-avatar.png";
import { netLogin, netLogout } from "@/utils/server";
import { decryptAES, encryptAES } from "@/utils/crypto";
import useHiveLog from "@/hooks/useHiveLog";
import styles from '@/views/krfic/index.module.scss';

const clientId = "752905746605-0mef8oelur0skk0s5ks4eadcqgf80auu.apps.googleusercontent.com";
const appId = "928418217871102";
const appName = "소설더미";
