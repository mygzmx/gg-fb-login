...
import logoImg from "@/common/logos/xsdq.png";
...
import styles from '@/views/xsdq/index.module.scss';

const clientId = "103788023534-arsts0jc8a6e0iplb3tdl5tivgloe4mm.apps.googleusercontent.com";
const appId = "450687915521028";
const appName = "小說大全";
